...
__all__ = [
    'DISPID_SRRAlternates', 'DISPID_SPEEngineConfidence',
    'DISPID_SVGetAudioOutputs', 'ISpeechFileStream',
    'SPRST_ACTIVE_ALWAYS', 'SAFTGSM610_22kHzMono',
    'SAFT12kHz8BitMono', 'SPEI_MAX_SR',
    'ISpeechLexiconPronunciations', 'SP_VISEME_5', 'SGDisplay',
    'SPGRAMMARWORDTYPE', 'SPPHRASEREPLACEMENT',
    'DISPID_SpeechRecoResult2', 'SVP_1',
    'SSSPTRelativeToCurrentPosition',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'tagSPTEXTSELECTIONINFO',
    'ISpRecognizer2', 'SPGS_ENABLED', 'SAFT11kHz16BitStereo',
    'SpeechTokenValueCLSID', 'SpeechRecoEvents',
    'DISPID_SABIMinNotification', 'DISPID_SPRText',
    'SpPhoneConverter', 'SAFT24kHz16BitMono', 'DISPID_SOTCategory',
    'DISPID_SpeechWaveFormatEx', 'SAFTADPCM_44kHzStereo',
    'ISpeechPhraseRules', 'SPEI_FALSE_RECOGNITION', 'SPPS_Function',
    'DISPIDSPRG', 'SPLEXICONTYPE', 'eWORDTYPE_ADDED', 'SVPNormal',
    'SpeechCategoryRecognizers', 'DISPID_SRRDiscardResultInfo',
    'eLEXTYPE_PRIVATE7', 'SPWF_SRENGINE', 'DISPID_SVSRunningState',
    'IStream', 'DISPID_SDKDeleteKey', 'DISPID_SRGCmdSetRuleIdState',
    'SpeechTokenIdUserLexicon', 'DISPID_SVSpeakStream',
    'SPPS_RESERVED1', 'SPPS_RESERVED4', 'SPPS_Noun',
    'DISPID_SGRSTPropertyId', 'DISPID_SPPParent', 'DISPID_SVSpeak',
    'SPFM_CREATE', 'SRTStandard', 'SpeechGrammarState',
    'SpWaveFormatEx', 'DISPID_SLWWord', 'SECFIgnoreKanaType',
    'ISpeechDataKey', 'ISpeechRecoResult2', 'eWORDTYPE_DELETED',
    'SAFTADPCM_8kHzMono', 'SpeechAudioFormatType', 'SpeechWordType',
    'DISPID_SPPValue', 'SPPS_Modifier', 'SRSInactive',
    'SpeechTokenContext', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SPPChildren', 'DISPID_SpeechRecoContextEvents',
    'SITooFast', 'SAFT16kHz16BitStereo', 'eLEXTYPE_PRIVATE3',
    'ISpeechPhraseProperty', 'DISPID_SVEventInterests',
    'DISPID_SRCCreateResultFromMemory', 'ISpeechVoiceStatus',
    'DISPID_SFSClose', 'DISPID_SPRsCount', 'eLEXTYPE_PRIVATE18',
    'SRESoundStart', 'SPEI_SR_AUDIO_LEVEL', 'SPRST_ACTIVE',
    'eLEXTYPE_PRIVATE17', 'SpeechCategoryAudioIn',
    'DISPID_SPRuleConfidence', 'ISpRecoGrammar',
    'SpeechPropertyResponseSpeed', 'SPSHORTCUTPAIR', 'SPLO_STATIC',
    'SAFT22kHz16BitMono', 'eLEXTYPE_RESERVED10',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SPEDisplayAttributes',
    'SREStreamEnd', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPINTERFERENCE_TOOLOUD', 'SPEI_UNDEFINED',
    'DISPID_SOTMatchesAttributes', 'SRERequestUI',
    'DISPID_SCSBaseStream', 'SPWORD', 'SPVOICESTATUS', 'SPSHT_OTHER',
    'DISPID_SPACommit', 'SECFEmulateResult', 'DISPID_SGRInitialState',
    'SPLOADOPTIONS', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SPILanguageId', 'SVP_15', 'DISPID_SRCVoice',
    'eLEXTYPE_PRIVATE15', 'SLTApp', 'DISPID_SASCurrentDevicePosition',
    'SP_VISEME_2', 'DISPID_SGRSTPropertyValue', 'DISPID_SRRecognizer',
    'SPEI_TTS_PRIVATE', 'SPPS_Unknown',
    'DISPID_SpeechObjectTokenCategory', 'SVEStartInputStream',
    'SAFT12kHz16BitStereo', 'SPCONTEXTSTATE', 'DISPID_SDKOpenKey',
    'DISPID_SPEsCount', 'SAFT11kHz8BitMono', 'ISpProperties',
    'SPEI_START_SR_STREAM', 'SRAInterpreter',
    'SpeechGrammarTagDictation', 'DISPID_SVESentenceBoundary',
    'DISPID_SGRSTPropertyName', 'DISPID_SPPId',
    ...
    'SVEEndInputStream', 'SVSFPurgeBeforeSpeak', 'DISPID_SGRSTWeight',
    'SpObjectTokenCategory', 'DISPID_SLPPhoneIds',
    'SpeechCategoryAudioOut', 'DISPID_SRStatus',
    'DISPID_SGRSTNextState', 'DISPID_SPCPhoneToId', 'DISPID_SOTSetId',
    'DISPID_SOTsItem', 'ISpeechPhraseRule',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpeechRecoResult', 'SpeechUserTraining', 'DISPID_SMSALineId',
    'SVSFParseSapi', 'DISPID_SpeechPhraseElement', 'SPVPRI_NORMAL',
    'DISPID_SRGIsPronounceable', 'DISPID_SRCCreateGrammar',
    'SDKLDefaultLocation', 'SVP_19', 'DISPID_SPIGetDisplayAttributes',
    'SAFTADPCM_8kHzStereo', 'SPEVENT', 'SVP_4', 'DISPID_SVSVisemeId',
    'DISPID_SRCERequestUI', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPDATAKEYLOCATION', 'SVEBookmark', 'DISPID_SpeechPhoneConverter',
    'SPVPRI_OVER', 'ISpRecognizer', 'SPSModifier', 'IEnumString',
    'DISPID_SPPConfidence', 'SAFT8kHz8BitStereo', 'ISpPhrase',
    'SAFT8kHz8BitMono', 'DISPID_SGRs_NewEnum', 'SAFT32kHz8BitMono',
    'SAFTCCITT_ALaw_22kHzMono', 'SPBO_PAUSE',
    'DISPID_SRCEventInterests', 'DISPID_SDKEnumKeys',
    'SPSNotOverriden', 'SREStateChange', 'SPDKL_LocalMachine',
    'SRSActive', 'DISPID_SRCEPhraseStart', 'SPEI_PROPERTY_NUM_CHANGE',
    'SpeechAllElements', 'SpeechDictationTopicSpelling',
    'DISPID_SGRsItem', 'DISPID_SpeechObjectTokens', 'SPPS_LMA',
    'DISPID_SWFEFormatTag', 'SRCS_Disabled', 'DISPID_SGRSTransitions',
    'DISPID_SABufferInfo', 'DISPID_SPRuleId', 'DISPID_SRCBookmark',
    'DISPID_SVSLastBookmarkId', 'SPSMF_UPS', 'SP_VISEME_3',
    'SPRECOCONTEXTSTATUS', 'DISPID_SOTCSetId', 'STSF_LocalAppData',
    ...
    'SPCT_SUB_COMMAND', 'eLEXTYPE_PRIVATE8', 'DISPID_SRGId',
    'SGRSTTWildcard', 'DISPID_SRGCmdLoadFromObject', 'SDTProperty',
    'SLTUser', 'ISpeechLexiconWord', 'SPSFunction',
    'DISPID_SRSClsidEngine', 'SVSFUnusedFlags', 'SpMemoryStream',
    'SPSLMA', 'DISPID_SVSLastStreamNumberQueued',
    'SPSERIALIZEDPHRASE', 'eLEXTYPE_PRIVATE11', 'SPPS_RESERVED2',
    'DISPID_SAFGuid', 'SP_VISEME_15', 'DISPID_SpeechRecognizer',
    'SpAudioFormat', 'DISPID_SpeechRecognizerStatus',
    'ISpeechGrammarRules', 'SVP_8', 'SPINTERFERENCE_NONE',
    'SLODynamic', 'SSFMOpenForRead', 'SAFTADPCM_11kHzMono',
    'SpeechVoiceEvents', 'SPEI_PHONEME', 'DISPID_SRCESoundEnd',
    'SPEI_PHRASE_START', 'DISPID_SLWsCount', 'SREFalseRecognition',
    'DISPID_SBSSeek', 'DISPID_SRRTimes', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SRGetFormat', 'SpMMAudioOut', 'SpeechLoadOption',
    'DISPID_SRIsUISupported', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SRCEBookmark', 'SREHypothesis',
    'DISPID_SVSInputWordLength', 'DISPID_SRCEStartStream',
    'SDTAlternates', 'tagSTATSTG', 'SVSFNLPMask', 'SINone',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SVSyncronousSpeakTimeout',
    'SGDSActive', 'DISPID_SPIReplacements', 'DISPID_SLGetWords',
    'DISPID_SWFEBitsPerSample', 'DISPID_SRState',
    'SPEI_RECO_STATE_CHANGE', 'SpPhraseInfoBuilder',
    'DISPID_SpeechGrammarRules', 'SDA_One_Trailing_Space',
    'STSF_CommonAppData', 'SSSPTRelativeToEnd',
    'SpTextSelectionInformation', 'DISPID_SVEViseme', 'SVP_11',
    'SRAORetainAudio', 'SpeechEmulationCompareFlags',
    'STCLocalServer', 'SVSFParseAutodetect', 'SPAO_RETAIN_AUDIO',
    'ISpeechObjectTokens', 'DISPID_SOTCGetDataKey',
    'DISPID_SRSCurrentStreamPosition', 'SRSEIsSpeaking',
    'SREInterference', 'SP_VISEME_12', 'DISPID_SAFType',
    'SRSInactiveWithPurge', 'SRARoot', 'SPWORDPRONOUNCEABLE',
    'SVSFlagsAsync', 'DISPID_SWFEBlockAlign',
    'DISPID_SVIsUISupported', 'DISPID_SPERetainedStreamOffset',
    'SpeechEngineProperties', 'DISPID_SPRuleFirstElement',
    'SSFMOpenReadWrite', 'SITooLoud', 'eLEXTYPE_RESERVED9',
    'SWTAdded', 'SAFT22kHz8BitMono', 'SPEI_RESERVED3',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SDTAudio',
    'DISPID_SPELexicalForm',
    'SpeechPropertyNormalConfidenceThreshold', 'SECLowConfidence',
    'SPEI_TTS_AUDIO_LEVEL', 'SPAS_CLOSED', 'SVP_5', 'SpeechRuleState',
    '_RemotableHandle', 'DISPID_SPRuleName',
    'ISpeechPhraseProperties', 'DISPID_SVSLastResult',
    'SpeechAudioVolume', 'DISPID_SRSetPropertyString',
    'DISPID_SRGState', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SRGDictationSetState', 'DISPID_SpeechVoice',
    'SP_VISEME_4', 'SVP_0', 'ISpeechPhraseAlternate', 'SVP_12',
    'SPRECORESULTTIMES', 'SRSEDone', 'DISPID_SRDisplayUI',
    'ISpeechLexiconWords', 'ISpeechPhraseReplacement',
    'SPEI_SR_BOOKMARK', 'SpeechAudioFormatGUIDText',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpeechRecoContextState',
    'SGDSActiveWithAutoPause', 'DISPID_SpeechRecoResultTimes',
    'SPWF_INPUT', 'DISPID_SRCPause', 'SREStreamStart',
    'DISPID_SVVolume', 'STCInprocHandler', 'SPXRO_SML',
    'DISPID_SLWPronunciations', 'eLEXTYPE_PRIVATE20',
    'DISPID_SVEStreamEnd', 'SVEAudioLevel', 'DISPID_SLWLangId',
    'SpeechVoiceSkipTypeSentence', 'Speech_StreamPos_Asap',
    'SBOPause', 'SPPS_RESERVED3', 'STCAll',
    'DISPID_SOTCreateInstance', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SRRGetXMLErrorInfo', 'SPPS_Interjection',
    'DISPID_SPAsItem', 'ISpeechPhraseElement', 'SPSNoun',
    'DISPID_SRGCmdLoadFromFile', 'SP_VISEME_1', 'DISPID_SOTCDefault',
    ...
    'SpMMAudioEnum', 'UINT_PTR', 'SPVPRI_ALERT', 'ISpeechMMSysAudio',
    'SpeechCategoryRecoProfiles', 'SAFTNonStandardFormat',
    'ISpeechAudio', 'SAFTExtendedAudioFormat', 'SpeechTokenKeyFiles',
    'SpeechCategoryPhoneConverters', 'DISPID_SRCEHypothesis',
    'SAFTGSM610_44kHzMono', 'DISPID_SGRsDynamic', 'SPAS_PAUSE',
    'DISPID_SPAs_NewEnum', 'DISPID_SRCERecognizerStateChange',
    '__MIDL_IWinTypes_0009', 'SFTInput', 'SPPS_Verb',
    'SpeechTokenShellFolder', 'DISPID_SPIGrammarId',
    'DISPID_SpeechPhraseElements', 'SpNullPhoneConverter',
    'SPADAPTATIONRELEVANCE', 'SPWORDTYPE', 'SP_VISEME_6',
    'SPSUnknown', 'SAFTNoAssignedFormat', 'DISPID_SGRAddState',
    'SPLO_DYNAMIC', 'ISpRecoResult', 'ISpPhoneticAlphabetSelection',
    'SSTTWildcard', 'SRERecognition', 'SITooSlow', 'SPGS_DISABLED',
    'SpMMAudioIn', 'SREPropertyNumChange', 'DISPID_SLPsCount',
    'DISPID_SPEAudioSizeBytes', 'ISpeechGrammarRuleState',
    'eLEXTYPE_RESERVED6', 'SpeechDataKeyLocation',
    'DISPID_SpeechObjectToken', 'DISPID_SRGDictationLoad',
    'STCRemoteServer', 'SVEAllEvents', 'SAFT24kHz8BitStereo',
    'ISpLexicon', 'DISPID_SBSFormat', 'DISPID_SPPsItem',
    'SGRSTTDictation', 'DISPID_SVAlertBoundary', 'SPRECOGNIZERSTATUS',
    'DISPID_SBSRead', 'DISPID_SPIEnginePrivateData',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'ISpObjectWithToken', 'SRAExport', 'DISPID_SRCEAudioLevel',
    'DISPID_SRCSetAdaptationData', 'SPPS_NotOverriden',
    'DISPID_SGRsCount', 'ISpRecognizer3',
    ...
    'eLEXTYPE_PRIVATE12', 'SAFT24kHz16BitStereo',
    'SAFT32kHz16BitStereo', 'DISPID_SpeechMemoryStream', 'SPWORDLIST',
    'DISPID_SpeechFileStream', 'SPEI_RECOGNITION',
    'SPEI_RECO_OTHER_CONTEXT', 'SPFM_OPEN_READWRITE',
    'DISPID_SRRTTickCount', 'SpeechDisplayAttributes',
    'SPSEMANTICERRORINFO', 'SpeechVisemeFeature',
    'DISPID_SpeechLexiconWords', 'SPDKL_DefaultLocation',
    'SVEPhoneme', 'SGRSTTEpsilon', 'SAFTGSM610_11kHzMono',
    'DISPID_SPCLangId', 'DISPID_SpeechPhraseAlternates',
    'ISpeechGrammarRuleStateTransitions', 'SPEI_START_INPUT_STREAM',
    'SpeechTokenKeyAttributes', 'SBONone', 'SVP_13', 'SVP_17',
    'DISPID_SRProfile', 'DISPID_SDKEnumValues', 'SpSharedRecognizer',
    'ISpeechResourceLoader', 'SpeechPartOfSpeech', 'SPAUDIOSTATUS',
    'SDTDisplayText', 'DISPID_SpeechPhraseReplacement',
    'SPBINARYGRAMMAR', 'SPCT_SLEEP', 'DISPID_SLWs_NewEnum',
    'SPXMLRESULTOPTIONS', 'SGLexicalNoSpecialChars',
    'DISPID_SRRAudio', 'SPGRAMMARSTATE', 'SVP_14',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SPIGetText', 'SPEI_RESERVED2',
    'SpShortcut', 'SVEViseme', 'DISPID_SRCVoicePurgeEvent',
    'SpeechVoicePriority', 'SRADefaultToActive',
    'DISPID_SOTIsUISupported', 'SVSFPersistXML', 'SPEI_RESERVED1',
    'eLEXTYPE_RESERVED8', 'eLEXTYPE_PRIVATE1', 'SDKLLocalMachine',
    'SPEI_RESERVED6', 'SASPause', 'SPSInterjection',
    'DISPID_SASState', '_ISpeechVoiceEvents', 'SPVISEMES',
    'DISPID_SRIsShared', 'DISPID_SPRs_NewEnum', 'DISPID_SPPsCount',
    'DISPID_SRRTStreamTime', 'Speech_Max_Word_Length',
    'SRERecoOtherContext', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SRCState', 'SPRS_ACTIVE', 'ISequentialStream',
    'SPDKL_CurrentUser', 'SVF_None', 'SGRSTTTextBuffer', 'LONG_PTR',
    ...
    'SAFT12kHz8BitStereo', 'SPTEXTSELECTIONINFO', 'SpStream',
    'DISPID_SDKCreateKey', 'SAFTADPCM_22kHzMono', 'SPEI_VISEME',
    'SDKLCurrentUser', 'SPINTERFERENCE_NOISE', 'DISPID_SAStatus',
    'DISPID_SVEWord', 'DISPID_SGRSTs_NewEnum', 'DISPID_SVSkip',
    ...
    'SPINTERFERENCE', 'DISPID_SPEActualConfidence',
    'SAFT44kHz16BitStereo', 'Speech_StreamPos_RealTime',
    'DISPID_SRCESoundStart', 'ISpSerializeState', 'SpCustomStream',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SGRName',
    'DISPID_SGRSTRule', 'DISPID_SVPause', 'ISpeechPhraseElements',
    'SP_VISEME_11', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SGRAddResource', 'SpCompressedLexicon',
    'DISPID_SPIStartTime', 'ISpObjectToken', 'SASClosed', 'SINoise',
    'SPRECOSTATE', 'SP_VISEME_16', 'DISPID_SVGetAudioInputs',
    'SPAS_STOP', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SPISaveToMemory',
    'DISPID_SPRsItem', 'SPCS_ENABLED', 'SpeechPropertyResourceUsage',
    'DISPID_SpeechAudio', 'DISPID_SLPSymbolic',
    'DISPID_SRRGetXMLResult', 'DISPID_SPPEngineConfidence',
    'SDA_Consume_Leading_Spaces', 'DISPID_SAFGetWaveFormatEx',
    'SWPKnownWordPronounceable', 'STSF_FlagCreate', 'DISPID_SVResume',
    'eLEXTYPE_PRIVATE9', 'SREAudioLevel', 'SPSSuppressWord',
    'SPAUDIOBUFFERINFO', 'STSF_AppData', 'SPSEMANTICFORMAT',
    'SGRSTTWord', 'SAFT24kHz8BitMono', 'DISPID_SREmulateRecognition',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SVEBookmark',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SPAPhraseInfo',
    'SPEI_INTERFERENCE', 'DISPID_SpeechPhraseProperty',
    'DISPID_SVRate', 'ISpeechPhraseInfo', 'SpeechStreamFileMode',
    'SVP_18', 'DISPID_SRAudioInput', 'SPVPRIORITY',
    'SPEI_SENTENCE_BOUNDARY', 'SREPropertyStringChange', 'SVEPrivate',
    'DISPID_SRGReset', 'DISPID_SOTGetAttribute',
    'DISPID_SWFESamplesPerSec', 'SRTEmulated', 'ISpGrammarBuilder',
    'DISPID_SPRulesCount', 'DISPID_SRRRecoContext',
    'DISPID_SRRSetTextFeedback', 'DISPID_SPPs_NewEnum', 'SVP_7',
    'SP_VISEME_13', 'DISPID_SMSAMMHandle',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SPEsItem',
    'SPRS_INACTIVE', 'ISpeechRecognizerStatus', 'SRTExtendableParse',
    'SPAS_RUN', '_SPAUDIOSTATE', 'SPGS_EXCLUSIVE',
    'DISPID_SpeechPhraseRule', 'ISpeechRecoGrammar', 'SGLexical',
    'DISPID_SVSPhonemeId', 'DISPID_SVSpeakCompleteEvent',
    'ISpRecoCategory', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SPRNumberOfElements', 'DISPID_SRCRecognizer',
    'SVSFVoiceMask', 'SPSERIALIZEDRESULT', 'SPCS_DISABLED',
    'IInternetSecurityManager', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SRCreateRecoContext', 'DISPID_SVEPhoneme',
    'DISPID_SDKSetLongValue', 'DISPID_SLWsItem', 'SAFT16kHz16BitMono',
    'DISPID_SASNonBlockingIO', 'ISpeechRecoContext',
    'ISpeechXMLRecoResult', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SPEPronunciation', 'SVPOver', 'IInternetSecurityMgrSite',
    'SpeechAddRemoveWord', 'SpObjectToken', 'SREAllEvents',
    'DISPID_SVPriority', 'SpeechAudioState', 'ISpeechRecoResultTimes',
    'SGSExclusive', 'SAFTText', 'DISPID_SRCERecognition',
    'SPINTERFERENCE_TOOSLOW', 'SpeechCategoryAppLexicons', 'SVP_6',
    'SAFTCCITT_uLaw_11kHzStereo', 'eLEXTYPE_PRIVATE10', 'SPSVerb',
    'SPEI_HYPOTHESIS', 'SREPrivate', 'DISPID_SpeechAudioFormat',
    'SP_VISEME_8', 'SAFT44kHz8BitStereo', 'DISPID_SGRSTType',
    'DISPID_SASFreeBufferSpace', 'DISPID_SGRSTsCount', 'SVPAlert',
    'SVF_Emphasis', 'SAFT32kHz8BitStereo', 'DISPID_SPIProperties',
    'DISPID_SPIElements', 'DISPID_SVWaitUntilDone',
    'SPEI_SOUND_START', 'DISPID_SPERequiredConfidence',
    'DISPID_SOTId', 'DISPID_SVAudioOutput', 'ISpeechLexicon',
    'SGSEnabled', 'SAFTGSM610_8kHzMono', 'Speech_Default_Weight',
    'DISPID_SVSInputSentencePosition', 'eLEXTYPE_PRIVATE13',
    'SSTTTextBuffer', 'SVSFIsXML', 'SSTTDictation',
    'DISPID_SMSADeviceId', 'SpVoice', 'ISpeechVoice', 'SPSHT_EMAIL',
    ...
    'SDA_Two_Trailing_Spaces', 'DISPID_SRRTLength', 'ISpMMSysAudio',
    'SPEI_WORD_BOUNDARY', 'SPBO_TIME_UNITS', 'DISPID_SRGCommit',
    'DISPID_SPRDisplayAttributes', 'DISPID_SPAStartElementInResult',
    'SVESentenceBoundary', 'SPINTERFERENCE_NOSIGNAL',
    'SAFT48kHz8BitStereo', 'WAVEFORMATEX', 'ISpeechRecognizer',
    'SPAR_Medium', 'DISPID_SPIRule', 'DISPID_SVDisplayUI',
    'SPEI_SR_PRIVATE', 'DISPID_SpeechPhraseRules',
    'SPFM_CREATE_ALWAYS', 'SVEVoiceChange', 'SPXRO_Alternates_SML',
    'SpeechRegistryUserRoot', 'SVSFNLPSpeakPunc', 'ISpRecoContext2',
    'eLEXTYPE_VENDORLEXICON', 'SINoSignal', 'SVF_Stressed',
    'DISPID_SGRAttributes', 'DISPID_SPIAudioStreamPosition',
    'ISpeechAudioStatus', 'SPPHRASEPROPERTY', 'SpeechRecognizerState',
    'SPFM_OPEN_READONLY', 'DISPID_SGRSRule',
    'DISPID_SpeechPhraseProperties',
    'ISpeechTextSelectionInformation', 'ISpShortcut',
    'DISPID_SVStatus', 'SP_VISEME_20', 'DISPID_SABIBufferSize',
    'DISPID_SABufferNotifySize', 'ISpRecoContext',
    'DISPID_SpeechMMSysAudio', 'SPEI_MIN_TTS', 'SSSPTRelativeToStart',
    'DISPID_SpeechRecoContext', 'SLOStatic', 'SPINTERFERENCE_TOOFAST',
    'SVP_9', 'DISPID_SLPLangId', 'DISPID_SVEVoiceChange',
    'SPRST_INACTIVE_WITH_PURGE', 'SPFILEMODE',
    'DISPID_SPRuleNumberOfElements', 'SpFileStream',
    'DISPID_SpeechCustomStream', 'SAFT8kHz16BitMono', 'SRTSMLTimeout',
    'SAFTADPCM_44kHzMono', 'SVSFParseSsml', 'DISPID_SpeechLexicon',
    'SREBookmark', 'SpeechLexiconType', 'SVP_16', 'SAFTDefault',
    'SpeechGrammarRuleStateTransitionType',
    'SWPUnknownWordPronounceable', 'SVEWordBoundary',
    'DISPID_SFSOpen', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'ISpeechBaseStream', 'DISPID_SGRsCommit', 'SAFT22kHz16BitStereo',
    'SAFT48kHz16BitMono', 'SAFTCCITT_ALaw_11kHzStereo', 'SGSDisabled',
    'DISPID_SLPPartOfSpeech', 'SRAImport',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SDKGetStringValue',
    'SVSFDefault', 'SDTPronunciation', 'SPPS_Noncontent',
    'ISpNotifyTranslator', 'SpeechBookmarkOptions',
    'SGPronounciation', 'SP_VISEME_9', 'DISPID_SBSWrite',
    'DISPID_SVSInputWordPosition', 'DISPID_SVGetProfiles',
    'SGRSTTRule', 'ISpDataKey', 'DISPID_SVGetVoices',
    ...
    'SPBOOKMARKOPTIONS', 'DISPID_SPPName', 'SDTRule', 'SITooQuiet',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SFTSREngine',
    'SPPS_SuppressWord', 'DISPID_SRCEPropertyNumberChange',
    'SPEI_VOICE_CHANGE', 'SPWT_LEXICAL', 'ISpStream',
    'DISPID_SMSGetData', 'DISPID_SLPType',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SLGetPronunciations',
    'DISPID_SLPsItem', 'DISPID_SGRsFindRule', 'SAFT44kHz16BitMono',
    'DISPID_SVSInputSentenceLength', 'ISpXMLRecoResult',
    'DISPID_SDKDeleteValue', 'SpeechTokenKeyUI', 'SPEI_END_SR_STREAM',
    'DISPID_SPAsCount', 'SDTReplacement', 'SPAUDIOOPTIONS',
    'ISpAudio', 'DISPID_SLAddPronunciation', 'SVP_10',
    'DISPID_SRSAudioStatus', 'DISPID_SRCEEndStream',
    'SAFT16kHz8BitMono', 'eLEXTYPE_LETTERTOSOUND', 'eLEXTYPE_APP',
    ...
    'DISPID_SVEAudioLevel', 'DISPID_SRGRules', 'SPPHRASERULE',
    'SPEI_END_INPUT_STREAM', 'SPEVENTENUM',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SP_VISEME_0',
    'SPAR_Unknown', 'DISPID_SVAudioOutputStream', 'SPAUDIOSTATE',
    'SpeechRuleAttributes', 'SP_VISEME_10', 'SPRST_NUM_STATES',
    'SPSTREAMFORMATTYPE', 'DISPIDSPTSI', 'DISPID_SGRsAdd', 'SASStop',
    ...
    'DISPID_SMSSetData', 'SPPROPERTYINFO', 'ISpResourceManager',
    'SAFT16kHz8BitStereo', 'eLEXTYPE_RESERVED7',
    'DISPID_SRCRequestedUIType', 'SPSHORTCUTTYPE',
    'SAFT48kHz8BitMono', 'SpeechPropertyAdaptationOn',
    'DISPID_SOTCId', 'DISPID_SRGRecoContext', 'SpeechCategoryVoices',
    'SRTReSent', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPAO_NONE',
    'SDKLCurrentConfig', 'DISPID_SRCEEnginePrivate', 'SVP_21',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SDKGetlongValue',
    'SPWT_DISPLAY', 'DISPID_SLAddPronunciationByPhoneIds',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SRGCmdSetRuleState', 'SPEI_MAX_TTS', 'DISPID_SPIEngineId',
    'SECFDefault', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SRRAudioFormat', 'DISPID_SOTDataKey',
    'SpeechWordPronounceable', 'ISpRecoGrammar2',
    'SAFT32kHz16BitMono', 'SECFIgnoreCase', 'SAFT8kHz16BitStereo',
    'SpeechEngineConfidence', 'SpInprocRecognizer',
    ...
    'eLEXTYPE_USER', 'DISPID_SVVoice', 'SPAR_Low',
    'ISpeechMemoryStream', 'IEnumSpObjectTokens', 'SP_VISEME_18',
    'SRATopLevel', 'SREPhraseStart', 'DISPID_SRCResume',
    'DISPID_SPEAudioSizeTime', 'DISPID_SRGetRecognizers',
    'ISpStreamFormatConverter', 'SAFT11kHz16BitMono', 'SVP_2',
    'SECFNoSpecialChars', 'SpeechStreamSeekPositionType',
    'SAFT22kHz8BitStereo', 'SPSMF_SRGS_SAPIPROPERTIES',
    'eLEXTYPE_PRIVATE2', 'SPWT_PRONUNCIATION',
    ...
    'SGDSActiveUserDelimited', 'DISPID_SGRSTText',
    'DISPID_SpeechRecoResult', 'SAFT12kHz16BitMono', 'SPCT_COMMAND',
    'eLEXTYPE_PRIVATE14', 'ISpVoice', 'ISpEventSource',
    'SpeechRecognitionType', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SOTGetStorageFileName', 'SECNormalConfidence',
    'STCInprocServer', 'DISPID_SRSSupportedLanguages',
    'DISPID_SRRSaveToMemory', 'eLEXTYPE_PRIVATE4', 'SpeechFormatType',
    'ISpeechLexiconPronunciation', 'DISPID_SRGSetTextSelection',
    'SVP_20', 'SRAONone', 'DISPID_SLPs_NewEnum',
    'DISPID_SDKGetBinaryValue', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SPARecoResult', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SpeechPhraseInfo', 'SRTAutopause', 'SGDSInactive',
    'DISPID_SPPFirstElement', 'SpeechVoiceSpeakFlags',
    'SAFTCCITT_ALaw_8kHzMono', 'SPEI_SOUND_END',
    'DISPID_SPRFirstElement', 'SVSFIsFilename', 'eLEXTYPE_PRIVATE19',
    'SpLexicon', 'SRESoundEnd', 'DISPID_SGRClear',
    'SAFTCCITT_uLaw_44kHzStereo', 'SDA_No_Trailing_Space',
    'SpeechSpecialTransitionType', 'DISPID_SPIAudioSizeTime',
    'DISPID_SLGetGenerationChange', 'DISPID_SRRSpeakAudio',
    'SpeechVisemeType', 'SAFT11kHz8BitStereo', 'SPCATEGORYTYPE',
    'SPSHORTCUTPAIRLIST', 'ISpEventSink',
    'DISPID_SRSetPropertyNumber', 'SpeechInterference',
    'DISPID_SpeechDataKey', 'DISPID_SLRemovePronunciation',
    'SPPARTOFSPEECH', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SPANumberOfElementsInResult', 'SPPHRASEELEMENT',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SpeechVoiceStatus',
    'SAFTCCITT_uLaw_8kHzStereo', 'eLEXTYPE_PRIVATE5',
    'SAFTADPCM_22kHzStereo', 'SPEI_TTS_BOOKMARK',
    'SAFTCCITT_uLaw_44kHzMono', 'SRSActiveAlways', 'SVSFIsNotXML',
    'ISpNotifySink', 'DISPID_SGRsCommitAndSave', 'SDTAll',
    'SPBO_AHEAD', 'SPFM_NUM_MODES', 'SPSHT_Unknown',
    ...
    'SpInProcRecoContext', 'DISPID_SOTsCount', 'SAFT48kHz16BitStereo',
    'SPEI_MIN_SR', 'ISpeechWaveFormatEx', 'DISPID_SGRSTsItem',
    'tagSPPROPERTYINFO', 'SpResourceManager', 'SSFMCreateForWrite',
    'SPRST_INACTIVE', 'ISpeechRecoResultDispatch',
    ...
    'SREAdaptation', 'SPWORDPRONUNCIATION', 'DISPID_SABIEventBias',
    'DISPID_SWFEChannels', 'DISPID_SRCEAdaptation', 'SPRULESTATE',
    'ISpObjectTokenCategory', 'ISpeechObjectToken',
    ...
    'eLEXTYPE_USER_SHORTCUT', 'ISpPhoneConverter', 'SP_VISEME_17',
    'SpeechGrammarTagUnlimitedDictation', 'SPCT_DICTATION',
    'SPDKL_CurrentConfig', 'DISPID_SGRSAddWordTransition',
    'DISPID_SPPNumberOfElements', 'SPRULE', 'ISpStreamFormat',
    'SpeechDiscardType', 'ISpeechGrammarRule', 'SPAR_High',
    'DISPID_SAVolume', 'SPEI_ADAPTATION', 'SSFMCreate',
    'SECHighConfidence', 'ISpPhraseAlt', 'SRADynamic',
    'SDTLexicalForm'
]
